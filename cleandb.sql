...
(1, 2, '2017-04-07', 'Lorem Ipsum comment', 1),
(2, 2, '2017-04-03', 'What is this, I don\'t know!', 2);
...
INSERT INTO `posts` (`id`, `author`, `subject`, `message`, `date`, `topic`) VALUES
...
(1, 'admin', 'password', 'admin@localhost', 2),
(2, 'user', 'password', 'user@localhost', 0);
